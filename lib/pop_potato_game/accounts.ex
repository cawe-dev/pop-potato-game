defmodule PopPotatoGame.Accounts do
  @moduledoc """
  ...
  alias PopPotatoGame.Accounts.{User, UserToken, UserNotifier}
  ...
  See `PopPotatoGame.Accounts.User.email_changeset/3` for a list of supported options.
  ...
  See `PopPotatoGame.Accounts.User.password_changeset/3` for a list of supported options.
